...
for episode in range(episodes):
    ...
    while not done:
        ...
        score += reward
        cv2.putText(img, "After (x6):", (10, 30), cv2.FONT_ITALIC, 1, (0, 0, 0), thickness=2)
        cv2.putText(img, "Win: {}".format(episode), (FRAME_WIDTH-280, 30), cv2.FONT_ITALIC, 1, (0, 0, 0), thickness=2)
        cv2.putText(img, "Lose: 0", (FRAME_WIDTH-150, 30), cv2.FONT_ITALIC, 1, (0, 0, 0), thickness=2)
