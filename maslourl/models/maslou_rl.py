...
class MaslouRLModel2QDiscrete:
    ...
    def train(self, episodes, max_steps_for_episode, starting_epsilon=0.1, min_epsilon=0.1, epsilon_decay_for_episode=1,
              ...
              episodes_for_average_tracking=100, file_logger=FileLogger()):
        self.replay_buffer.clear()
        target_model = self.__copy_model(self.model)
        ...
        for episode in range(episodes):
            ...
            params = self.__get_params_for_episode()
