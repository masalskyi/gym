...
class PingPongModel(MaslouRLModel2QDiscrete):
    def build_model(self):
        ...
        x = layers.Conv2D(filters=32, kernel_size=8, strides=4, activation="relu", data_format='channels_first')(state_input)
        x = layers.Conv2D(filters=64, kernel_size=4, strides=2, activation="relu", data_format='channels_first')(x)
